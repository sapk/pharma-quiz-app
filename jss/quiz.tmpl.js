            ...
            1: function(value, ext) {
                if (value.length === 0) {
                    ...
                    return '<div class="col-xs-3" style="margin-left: 4.16%;"><input class="form-control input-lg" id="0" value="' + value[0] + '"/></div>\n\
                        <div class="col-xs-1" > - </div>\n\
                        <div class="col-xs-3"><input id="1" class="form-control input-lg"  value="' + value[2] + '"/></div>\n\
                        <div class="col-xs-3 col-xs-offset-1"><select class="form-control input-lg" ><option disabled selected style="display:none;" >' + Q.tool.get_unit(value) + '</option><option>L</option></select></div>';
                }
            }
        }
    },
